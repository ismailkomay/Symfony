...
class __TwigTemplate_42d2949434aa8e0b72f0254fbcb1925bf97c04b57990851f0100cb3ef7807a4b extends Twig_Template
{
    ...
    {
        // line 4
        echo "<div class=\"page-header\"><h1> Ajout d'un Type de Consommation</h1></div>
...
<div class=\"span5\">";
        // line 26
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "agence", array()), 'label', array("label" => " Agence "));
        echo "</div>
";
        // line 27
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "agence", array()), 'widget');
        echo "<span class=\"alert-danger \">";
