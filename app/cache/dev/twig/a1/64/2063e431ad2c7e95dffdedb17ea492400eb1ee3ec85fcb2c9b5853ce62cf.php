...
class __TwigTemplate_a1642063e431ad2c7e95dffdedb17ea492400eb1ee3ec85fcb2c9b5853ce62cf extends Twig_Template
{
    ...
    {
        // line 4
        echo "<div class=\"page-header\"><h1> Ajout d'un Chauffeur</h1></div>
...
<div class=\"span5\">";
        // line 46
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "dateembauche", array()), 'label', array("label" => " Date d'embauche "));
        echo "</div>
";
        // line 47
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "dateembauche", array()), 'widget');
        echo "<span class=\"alert-danger \">";
...
<div class=\"span5\">";
        // line 56
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "typeconvention", array()), 'label', array("label" => " Type De Convention "));
        echo "</div>
";
        // line 57
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "typeconvention", array()), 'widget');
        echo "<span class=\"alert-danger \">";
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "typeconvention", array()), 'errors');
        echo "</span>
</div>
...
<div class=\"span5\">";
        // line 61
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "etatContrat", array()), 'label', array("label" => " Etat de contrat "));
        echo "</div>
";
        // line 62
...
";
    ...
    {
        return array (  191 => 69,  179 => 62,  175 => 61,  166 => 57,  162 => 56,  153 => 52,  149 => 51,  140 => 47,  136 => 46,  127 => 42,  123 => 41,  114 => 37,  110 => 36,  101 => 32,  97 => 31,  88 => 27,  84 => 26,  75 => 22,  71 => 21,  57 => 10,  52 => 8,  46 => 4,  43 => 3,  37 => 2,  11 => 1,);
    }
}
