...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 09 Mars 2015 à 09:19
...
CREATE TABLE IF NOT EXISTS `missionaffretement` (
  ...
  `espece` tinyint(1) NOT NULL,
  `autredoc` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `missionaffretement` (`id`, `ecc`, `ect`, `ebl`, `espece`, `autredoc`, `valdeclassurance`, `bonlivraison`, `numexpedition`, `dateramassage`, `lieuramassage`, `nbrecolis`, `naturemarchandise`, `datelivraison`, `lieulivraison`, `montantfacture`, `remise`, `motifremise`, `montantregle`, `nombnq`, `numcheque`, `remarques`, `champssupp2`, `champssupp3`, `champssupp4`, `itineraire_id`, `feuilleDeRoute_id`, `client_id`) VALUES
(2, 0, 0, 0, 0, '00', 0, '', '', '2015-03-06 10:00:00', 'Tit Mellil', 100, '', '2015-03-06 16:00:00', 'Tit Mellil', 1800, 10, '', 0, '', '', '', '', '', '', 1, 1, 1);
...
INSERT INTO `utilisateur` (`id`, `nom`, `prenom`, `login`, `motDePasse`, `matricule`, `cin`, `tel`, `adresse`, `champSup1`, `champSup2`, `role_id`, `email`) VALUES
(1, 'Limouni', 'Asmaa', 'asmaa', 'asmaa', '291029', 'EE28320', '02930293', '', '', '', 1, NULL);
